...
from ..jit.add_distribution_function_time_slice import _append_Grts, _append_Grts_self
...
def _append_results(G_rts, xyz, g1, g2, cuvec, cuvol, r_range, nbins, pbc, opt, g1_lens=None, g2_lens=None, self_part=False):
    if pbc == 'ortho':
        if opt:
            if self_part:
                G_rts = _append_Grts_self(G_rts, xyz, g1, g2, g1_lens, g2_lens, cuvec, cuvol, r_range, nbins)
            else:
                G_rts = _append_Grts(G_rts, xyz, g1, g2, g1_lens, g2_lens, cuvec, cuvol, r_range, nbins)
