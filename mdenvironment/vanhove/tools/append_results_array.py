...
def _append_results(G_self, G_distinct, xyz, g1, g2, cuvec, cuvol, r_range, nbins, pbc, opt, g1_lens=None, g2_lens=None, self_only=False):
    ...
    if not opt:
        if pbc == 'ortho':
            r, G_self, G_distinct = _mic_append_Grts(G_self, G_distinct, xyz, g1, g2, cuvec, cuvol, r_range, nbins)
        else:
            r, G_self, G_distinct = _plain_append_Grts(G_self, G_distinct, xyz, g1, g2, cuvol, r_range, nbins)
